...
export const seedContacts: Contact[] = [
  {
    ...
    notes: "Primary operational stakeholder for warehouse, website, and portal work.",
    noteItems: [
      { id: "cn-dana-1", author: "M. Doyle", body: "Prefers Friday morning status updates before the ops standup.", createdAt: "Aug 2, 2026" },
    ],
    projectIds: ["p-warehouse", "p-website", "p-vendor"],
  },
  {
    id: "ct-ravi",
    name: "Ravi Thakur",
    ...
    notes: "IT owner for WMS roles, SSO, and vendor portal access.",
    noteItems: [
      { id: "cn-ravi-1", author: "J. Kim", body: "Waiting on SSO mapping for two portal users.", createdAt: "Aug 3, 2026" },
    ],
    projectIds: ["p-warehouse", "p-vendor"],
  },
  {
    id: "ct-nina",
    name: "Nina Ortiz",
    ...
    notes: "Procurement lead for the POS rollout. Invite to portal after MSA countersign.",
    projectIds: ["p-pos"],
  },
  {
    id: "ct-chris",
    ...
    email: "chris@bellweather.com",
    phone: "+1 206 555 0114",
    portal: "Enabled",
    lastInteraction: "Aug 4, 2026",
    notes: "Pilot sponsor for fleet tracking telemetry.",
    projectIds: ["p-fleet"],
  },
  {
    id: "ct-priya",
    ...
    title: "Support Lead",
    email: "priya@oakton.tech",
    phone: "+1 512 555 0177",
    portal: "Enabled",
    lastInteraction: "Jul 29, 2026",
    notes: "Owns the support mailbox and overdue retainer conversation.",
  },
];
